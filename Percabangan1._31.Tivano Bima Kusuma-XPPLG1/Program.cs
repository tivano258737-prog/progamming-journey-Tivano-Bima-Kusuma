...
namespace Percabangan1._31.Tivano_Bima_Kusuma_XPPLG1
{
        ...
        static void Main(string[] args)
        {
            ...
            switch (pilihan)
            {
                case 1:
                    ...
                    hasil = 6 * sisi * sisi;
                    Console.WriteLine($"Luas Permukaan Kubus = 6 × {sisi} × {sisi} = {hasil}");
                    break;
                ...
                case 2:
                    ...
                    Console.WriteLine($"Volume Kubus = {sisi} × {sisi} × {sisi} = {hasil}");
                    break;
                ...
                case 3:
                    ...
                    Console.WriteLine($"Luas Permukaan Balok = 2 × (({panjang}×{lebar}) + ({panjang}×{tinggi}) + ({lebar}×{tinggi})) = {hasil}");
                    break;
                ...
                case 4:
                    ...
                    Console.WriteLine($"Volume Balok = {panjang} × {lebar} × {tinggi} = {hasil}");
                    break;
